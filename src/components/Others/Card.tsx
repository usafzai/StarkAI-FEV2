    ...
    <>
      {props.flag === true ? (
        ...
        >
          ...
          {!props.hideDescription && <div className="absolute w-full h-full top-0 left-0 hover-ground opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-4 flex flex-col justify-start">
