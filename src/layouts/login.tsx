        ...
        <div className="w-[380px] h-full px-16 py-10 bg-darkPrimary rounded-tl-lg rounded-bl-lg">
          <div className="flex flex-col justify-between items-center gap-12">
            ...
            <div className="h-[1px] w-full relative bg-white/10">
              <div className="flex text-[12px] items-center justify-center rounded-[50%] absolute z-10 right-[86px] w-[32px] h-[32px] bg-darkPrimary border border-white/10 mt-[-16px]">
                OR
              </div>
            </div>
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="text-[14px] rounded-[4px] px-3.5 py-2 bg-black/25 appearance-none outline-none invalid:focus:border-danger-primary placeholder:text-light-secondary text-white disabled:text-opacity-60 disabled:cursor-not-allowed"
                ></input>
              </div>
              <div className="flex flex-col gap-1">
                <label className="text-[14px] font-medium lg:text-s text-white select-none">
              ...
              <div className="pt-[6px]">
                <button className="button-color w-full h-[38px] text-[14px] rounded-[4px]">
                  Sign in
                </button>
              </div>
