      ...
      <div className="w-full mx-auto flex flex-row justify-between items-center h-full px-10 border-b-[1px] border-[#e0bf16]">
        <div className="flex flex-row items-center gap-2">
          ...
          <Link className="flex flex-row" to="/">
            ...
            <h1 className="text-[26px] font-semibold font-chakra text-[#e0bf16]">
              AI
            </h1>
          </Link>
        </div>
        <div className="flex flex-row gap-3 items-center sm:hidden md:hidden">
          ...
          <Link to="/login">
            <span className="test-primary-button">Register</span>
          </Link>
          <Link to="/login">
            <span className="test-primary-button">Login</span>
          </Link>
        </div>
        <div
          id="hamburger_menu"
