        ...
        <div className="flex flex-col justify-center items-stretch gap-2 w-full max-w-xl mx-auto">
          <div className="relative flex items-end gap-2 bg-dark-elements rounded-[.625rem] py-2 pl-4 pr-2 min-h-[3rem]">
            ...
            <button
              ...
              className="rounded-md font-extra-thick flex items-center justify-center transition-colors disabled:cursor-not-allowed px-1.5 gap-1.5 py-1.5 !text-light-tertiary hover:bg-accent-hover text-dark-background bg-accent-primary"
            >
              <Icon
